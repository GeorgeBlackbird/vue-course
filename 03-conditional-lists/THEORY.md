...
*(Здесь был бы полезен GIF, иллюстрирующий проблему отсутствия key или использования index в качестве key при изменении порядка элементов в списке, особенно если элементы имеют состояние, например, поля ввода)*
